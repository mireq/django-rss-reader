    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xml_url', models.URLField(verbose_name='URL of feed')),
                ...
                ('updates_status', models.CharField(blank=True, choices=[('', 'Not updated'), ('u', 'Updated'), ('e', 'Update error')], max_length=1, verbose_name='update status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_uri', models.CharField(blank=True, max_length=1000, verbose_name='URI of author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feeds.Category', verbose_name='category')),
                ('feed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feeds.Feed', verbose_name='feed')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='feeds.News', verbose_name='news item')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
                'verbose_name': 'News status for user',
                'verbose_name_plural': 'News statuses for user',
            },
        ),
